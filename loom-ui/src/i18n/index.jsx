...
const TRANSLATIONS = {
  sl: {
    ...
    'clusters.about': 'Cluster je surova semantična skupina sanj, ki jo je zaznal engine — širša množica kot Vzorci (Patterns): vsak cluster, ki se dovolj ponavlja skozi čas, se avtomatsko pojavi tudi tam kot potrjljiv vzorec. Potrditev clustra pove engine-u "to je zame smiselna skupina" in ostane zapomnjeno tudi čez naslednje clustering rune; zavrnitev ne izbriše sanj, samo skrije to skupino iz predlogov.',
    'clusters.confirm': 'Potrdi grupo',
    'clusters.reject': 'Zavrni',
    'clusters.rename': 'Ime grupe',
    'clusters.rejectedNotice': 'Grupa ne bo več predlagana — sanje same ostanejo nedotaknjene.',
    'clusters.candidateType.thread': 'ponavljajoč vzorec',
    'clusters.candidateType.location': 'lokacija',
    'clusters.candidateType.entity': 'oseba/bitje',
    'clusters.candidateType.emotion': 'čustvo',
    'clusters.candidateType.unknown': 'neznano',
    ...
    'cycles.label': 'Cikel',
    'cycles.of': 'od',
    'cycles.night_notice': 'Ta sanja je del noči z več spalnimi cikli.',
    'common.error': 'Napaka',
  ...
  en: {
    ...
    'clusters.about': 'A cluster is a raw semantic group of dreams detected by the engine — a broader set than Patterns: any cluster that recurs often enough over time automatically also shows up there as a confirmable pattern. Confirming a cluster tells the engine "this grouping makes sense to me" and is remembered across future clustering runs; rejecting it does not delete the dreams, it just hides this grouping from suggestions.',
    'clusters.confirm': 'Confirm cluster',
    'clusters.reject': 'Reject',
    'clusters.rename': 'Cluster name',
    'clusters.rejectedNotice': 'This cluster will no longer be suggested — the dreams themselves are untouched.',
    'clusters.candidateType.thread': 'recurring pattern',
    'clusters.candidateType.location': 'location',
    'clusters.candidateType.entity': 'person/being',
    'clusters.candidateType.emotion': 'emotion',
    'clusters.candidateType.unknown': 'unknown',
    ...
    'cycles.label': 'Cycle',
    'cycles.of': 'of',
    'cycles.night_notice': 'This dream is part of a night with multiple sleep cycles.',
    'common.error': 'Error',
    'common.retry': 'Retry',
    'common.close': 'Close',
